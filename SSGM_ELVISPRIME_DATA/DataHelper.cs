...
namespace SSGM_ELVISPRIME_DATA
{
        ...
        public static string ConnectionString
        {
            get
            {
                if (string.IsNullOrEmpty(_connectionString))
                {
                    ...
                    {
                        _connectionString = ConfigurationManager.ConnectionStrings["ELVIS"].ConnectionString;
                    }
                }
        ...
        public static string ConnectionString_Select
        {
            set
            {
                ...
                else if (value == "SSGM")
                {
                    lock (_connectionStringLockObject)
                    {
                        _connectionString = ConfigurationManager.ConnectionStrings["SSGM"].ConnectionString;
                    }
                }                
                else
                {
