...
function fnSetYearQuarter() {
	try {
		...
		$.ajax({
			type: "POST",
			url: "/LogisticsInfo/fnSetYearQuarter",
			async: false,
			cache: false,
			dataType: "Json",
...
function fnSetAddrState() {
	...
	$.ajax({
		type: "POST",
		url: "/LogisticsInfo/fnSetAddrState",
		async: true,
		cache: false,
		dataType: "Json",
		data: { "vJsonData": _fnMakeJson(objJsonData) },
...
function fnSetAddrCity(vITEM1) {
	...
	$.ajax({
		type: "POST",
		url: "/LogisticsInfo/fnSetAddrCity",
		async: true,
		cache: false,
		dataType: "Json",
		data: { "vJsonData": _fnMakeJson(objJsonData) },
...
function fnSetAddrTownship(vITEM1, vITEM2) {
	...
	$.ajax({
		type: "POST",
		url: "/LogisticsInfo/fnSetAddrTownship",
		async: true,
		cache: false,
		dataType: "Json",
		data: { "vJsonData": _fnMakeJson(objJsonData) },
...
function fnSetAddrTownship2(vITEM1, vITEM2) {
	...
	$.ajax({
		type: "POST",
		url: "/LogisticsInfo/fnSetAddrTownship2",
		async: true,
		cache: false,
		dataType: "Json",
		data: { "vJsonData": _fnMakeJson(objJsonData) },
...
function fnSetSection() {
	...
	try {
		...
		if (fnCheckData()) {
			...
			$.ajax({
				type: "POST",
				url: "/LogisticsInfo/fnSetSection",
				async: false,
				cache: false,
				dataType: "Json",
				data: { "vJsonData": _fnMakeJson(objJsonData) },
...
function fnSetPremiumRate() {
	...
	try {
		if (fnCheckRate()) {
			...
			$.ajax({
				type: "POST",
				url: "/LogisticsInfo/fnSetPremiumRate",
				async: true,
				cache: false,
				dataType: "Json",
				data: { "vJsonData": _fnMakeJson(objJsonData) },
...
function fnTariffSerach() {
	...
	try {
		if (fnSearchCheck()) {
			...
			$.ajax({
				type: "POST",
				url: "/LogisticsInfo/fnTariffSerach",
				async: true,
				cache: false,
				dataType: "Json",
				data: { "vJsonData": _fnMakeJson(objJsonData) },
