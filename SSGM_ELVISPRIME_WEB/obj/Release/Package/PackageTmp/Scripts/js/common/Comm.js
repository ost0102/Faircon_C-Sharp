...
function _fnRequestMsg(msg) {
    $("#BookingRequest .inner").html(msg);
    layerPopup('#BookingRequest', "");
    $("#BookingRequest_confirm").focus();
}

function _fnModifyMsg(msg) {
    $("#BookingModify .inner").html(msg);
    layerPopup('#BookingModify', "");
    $("#BookingModify_confirm").focus();
}

function _fnCancelMsg(msg,mngtNo) {
    $("#BookingCancel .inner").html(msg);
    layerPopup('#BookingCancel', "");
    $("#BookingCancel_confirm").focus();
    $("#Delete_no").val(mngtNo);
}
//레이어 팝업
function _fnLayerConsoleAlertMsg(msg, mngtNo, seq, settime, realName) {
    $("#ConsoleCancel_content").html(msg);
    layerPopup3('#ConsoleCancel', "");
    $("#ConsoleDelete_Mngtno").val(mngtNo);
    $("#ConsoleDelete_Seq").val(seq);
    $("#ConsoleDelete_Settime").val(settime);
    $("#ConsoleDelete_RealName").val(realName);
    $("#ConsoleCancel_confirm").focus();
}
